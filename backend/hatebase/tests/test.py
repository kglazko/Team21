# Source: https://github.com/DanielJDufour/hatebase
...
class TestSightings(unittest.TestCase):
    ...
    def test_sightings(self):
        ...
        filters = {'is_about_nationality': '1',
                   'language': 'eng', 'country_id': 'US'}
        output = "json"
        # get sightings
    ...
    def test_vocabulary(self):
        ...
        if hatebase.debug == True:
            print("len(vocab): {}, # of pages: {}, # of results: {}, lang: {}".format(
                len(vocablist), pages, results, lang))
        self.assertEqual(response["token"], hatebase.token)
    ...
    def test_vocabulary_details(self):
        ...
        # get vocab details
        response = hatebase.getVocabularyDetails(
            filters=details_filters, format=format)
